...
<body style="background-color: #FBFAFB; ">
    ...
    <div
        ...
        <div style="display: flex;">
            ...
            <p style="margin-top: 10px;" class="text-xl font-semibold whitespace-nowrap dark:text-white">Approval Requests
                <br>
                <span style="color: #026ACB;">Approved Policies</span></p>
        </div>
    ...
    <div class="maindash">
        <div class="mobileview">
            ...
            <div onclick="window.location.href='./approvedpolicies.php'" class="mobdiv">Approved Policies</div>
        </div>
        <div class="leftdiv">
            ...
            <div onclick="window.location.href='./approvedpolicies.php'" class="ullisty"><p style="font-size: 20px;">Approved Policies</p></div>
        </div>
        <div class="rightdiv">
        ...
        <tbody>
            ...
            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                ...
                <td class="px-6 py-4" style="display: flex; gap: 10px;">
                    <button class="publishbtn">Approved</button>
                </td>
            </tr>
        </tbody>
        <?php } ?>
