...
<body style="background-color: #FBFAFB; ">
    ...
    <div
        ...
        <div style="display: flex;">
            ...
            <p style="margin-top: 10px;" class="text-xl font-semibold whitespace-nowrap dark:text-white">Approval Requests
                <br>
                <span style="color: #026ACB;">Pending Approvals</span></p>
        </div>
    ...
    <div class="maindash">
        <div class="mobileview">
            <div onclick="window.location.href='./pendingapprovals.php'" class="mobdiv">Pending Approvals</div>
            <div onclick="window.location.href='./rejectedapprovals.php'" class="mobdiv1">Rejected Requests</div>
            <div onclick="window.location.href='./approvedpolicies.php'" class="mobdiv1">Approved Policies</div>
        </div>
        <div class="leftdiv">
            <div onclick="window.location.href='./pendingapprovals.php'" class="ullisty"><p style="font-size: 20px;">Pending Approvals</p></div>
            <div onclick="window.location.href='./rejectedapprovals.php'" class="ullisty1"><p style="font-size: 20px;">Rejected Requests</p></div>
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4" style="display: flex; gap: 10px;">
                    <button onclick="window.location.href='Approvedetails.php?policy_title=<?php echo urlencode($result['policy_title']); ?>&policyno=<?php echo urlencode($result['policyno']); ?>'"  class="publishbtn">Action</button>
                </td>
            </tr>
        </tbody>
        <?php } ?>
