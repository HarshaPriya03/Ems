...
<body style="background-color: #FBFAFB; ">
    ...
    <div
        ...
        <div style="display: flex;">
            ...
            <p style="margin-top: 10px;" class="text-xl font-semibold whitespace-nowrap dark:text-white">Policy Detail
                <br>
                <span style="color: #026ACB;">Versions</span></p>
        </div>
    ...
    <div class="maindash">
        ...
        <div class="leftdiv">
            ...
            <div class="ullisty" ><p style="font-size: 20px;">Versions</p></div>
        ...
        <div class="rightdiv">
            <div class="relative overflow-x-auto" style="border-top-left-radius: 10px; border-top-right-radius: 10px; position: sticky; top: 0;">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <?php
                $sql = "SELECT * FROM policies_policy WHERE status = '1' AND policy_title = '$policy_title' ";
                $que = mysqli_query($con, $sql);
                while ($result = mysqli_fetch_assoc($que)) {
                ?>
                    <tbody>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <th scope="row" onclick="window.location.href='./policy_content.php?policyno=<?php echo urlencode($result['policyno']); ?>&policy_title=<?php echo urlencode($result['policy_title']); ?>&version=<?php echo urlencode($result['version']); ?>'" class="px-6 py-4 font-medium text-blue-700 whitespace-nowrap dark:text-blue" style="cursor: pointer;">
                            ...
                            <?php echo  $result['policy_category'];  ?>
                            </td>
