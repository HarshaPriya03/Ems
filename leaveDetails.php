...
<body>
  <div class="leaveoverview">
    ...
    <a class="anikahrm" id="anikaHRM">
      <span>Anika</span>
      <span class="hrm16" style="color:#45C380;">HRM</span>
    </a>
    ...
    <section class="rectangle-parent">
      ...
      <form id="employeeForm">
        ...
        <div class="margin-lg" style="position: absolute; z-index: 99; margin-left: 500px; margin-top: 370px;">
        ...
        <div class="margin-lg" style="position: absolute; z-index: 999999999999; margin-left: 695px; margin-top: 380px;">Leave Balance= <?php echo $row['co'] + $row['cl'] + $row['sl']; ?> </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="margin-left: 90px;">
              ...
              <form id="updateForm" data-id="<?php echo $ID; ?>">
                ...
                <input type="text" class="remove" name="mgrname" id="mgrname" readonly />
...
<script>
  ...
  function approveFunc() {
    ...
    var dropdown2341 = document.getElementById('mgrname');
    ...
    if (dropdown1.value === '3') {
      ...
      dropdown234.classList.remove('remove');
      dropdown2341.classList.remove('remove');
      ...
      dropdown2341.classList.add('remove');
