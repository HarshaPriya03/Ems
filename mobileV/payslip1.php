...
?>
  ...
  <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
         ...
         WHERE salarymonth = '$smonth' AND payroll_ss.empname = '$empname'
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        buttons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                xhr.open('GET', '../Payroll/fetch_ss_details.php?smonth=<?php echo $smonth; ?>&empname=' + empname, true);
                xhr.send();
            });
        });
        ...
        buttons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                downloadBtn.href = '../Payroll/print-details_pslip.php?smonth=<?php echo $smonth; ?>&empname=' + empname;
