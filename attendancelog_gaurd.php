...
if ($result) {
    ...
    if ($row && isset($row['user_type']) && isset($row['user_type1'])) {
        ...
        if ($user_type !== 'user' && $user_type1 !== 'admin' ) {
            header('location:loginpage.php');
            exit();
        }
    } else {
...
<html>
  ...
  <body>
    <div class="my-attendence">
      ...
      <div class="rectangle-parent" style="width: 1100px;">
      <table>
    <?php
...
";
    ...
    ?>
      ...
      <div class="rectangle-group">
        ...
        <a href="attendancelog.php" class="my-attendence1" id="myAttendence" style="margin-left: 74px;">Attendance Log</a>
      </div>
