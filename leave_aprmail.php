        ...
        <table border="0" cellspacing="0" cellpadding="0" width="600">
          <tr>
            <td align="center" bgcolor="#f0f0f0">
              ...
              <a href="https://hrms.anikasterilis.com/Approval-mob.php?email=<?php echo urlencode($apremail); ?>" style="background-color: #007BFF; color: #ffffff; display: inline-block; padding: 10px 20px; text-decoration: none; border-radius: 5px;">View Request</a>
