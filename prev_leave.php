...
<body>
  <div class="biometricmap">
    ...
    <div class="cards">
      <div class="card-1 " onclick="previous()">
        Leave Balance
      </div>
      <div class="card-2 active">
        Previous Year Leave Balance
      </div>
    </div>


    <div class="container" style="margin-top:170px;margin-left:373px;background-color:#fff;">
      <div class="row">
        <div class="col-md-8">
      ...
      <table class="table-bordered" id="attendanceTable" style="margin-left:auto; margin-right:auto;font-size:15px !important;">
        <thead style="position:sticky;top:0;">
          ...
          <tr class="static-cell">
            ...
            <?php
            $total_columns = 0;
            foreach ($months as $year => $year_months) : ?>
              <?php foreach ($year_months as $month_num => $month_name) : ?>
                ...
                <th colspan="<?php echo $num_columns; ?>"><?php echo $month_name . ' ' . $year; ?></th>
              <?php endforeach; ?>
            <?php endforeach; ?>
            <th>
              Last Updation
          ...
          <?php foreach ($employees as $employee) : ?>
            ...
            <tr>
              ...
              <td>
                ...
                <?php echo date('Y-m-d H:i:s', strtotime($result['lastupdate'] . ' +5 hours +30 minutes')); ?></td>
