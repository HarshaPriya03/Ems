...
<body>
    <div style="display: flex; justify-content: space-between;margin-bottom: 0;">
        ...
        <h1 style="text-align: center;">
            <u>GURUGRAM EMP's SALARY STATEMENT FOR THE MONTH of <?php echo $smonth; ?></u>
        </h1>
    ...
    <table border="1" style="border-color: rgb(170, 170, 170);width:100%;margin-top:-120px;" cellspacing="0">
        ...
        <tbody>
          ...
          emp.empname, 
          payroll_ban.*,
          (payroll_ss_ggm.emi + payroll_ss_ggm.misc) AS MISC
      FROM 
          payroll_ss_ggm
      LEFT JOIN 
          emp ON payroll_ss_ggm.empname = emp.empname
      LEFT JOIN 
          payroll_ban ON payroll_ss_ggm.empname = payroll_ban.empname
      WHERE 
          payroll_ss_ggm.salarymonth = '$currentMonth'
      ORDER BY 
          payroll_ss_ggm.emp_no ASC";
...
<?php 
$sql = "SELECT 
    SUM(payroll_ss_ggm.payout) AS total_payout
FROM 
    payroll_ss_ggm
WHERE 
    payroll_ss_ggm.salarymonth = '$currentMonth'";
