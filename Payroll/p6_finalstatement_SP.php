  ...
  <div class="attendence4">
    ...
    <div class="rectangle-parent23">
      ...
      <form id="employeeForm">
        <input type="hidden" name="status" value=6.3>
      ...
      <div style="position:absolute; height:800px; overflow-y:auto; margin-top:50px; width:100%; scale:0.9; ">
        <form>
          <table class="w-full text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400" id="ssTableBody">
            ...
            <th colspan=15 style="position: sticky; top: 0 !important;left: 0;z-index:100;background-color: #fdfdfd;" scope="col" class="px-6 py-2 text-center">
            SERVICE PROVIDER  EMPLOYEES SALARY STATEMENT - <?php echo $smonth; ?>
            </th>
            </tr>
              <tr style="border-top: 1px solid rgb(224, 224, 224);">
                <th colspan=22 scope="col" class="px-3 py-3" style="position: sticky; top:20px; left: 0;z-index:100;background-color: #fdfdfd;">
          ...
          <th colspan="1" style="text-align: center;position: sticky; left: 0; background-color: #fdfdfd;" scope="col" class="px-6 py-3">
            ...
            <th colspan="7" style="text-align: center; border-left: 1.5px solid rgb(160, 160, 160); background-color: rgba(255, 231, 194, 0.5);" scope="col" class="px-6 py-3">
              Days Calculation
            </th>
            ...
            <th scope="col" style="text-align: center;  border-left: 1.5px solid rgb(160, 160, 160);position: sticky; right: 0; top:0; background-color: #fdfdfd;" class="px-6 py-3">
                NET Payable
              </th>
              <th scope="col" colspan=2 style="text-align: center;  border-left: 1.5px solid rgb(160, 160, 160);position: sticky; right: 0; top:0; background-color: #fafdfa;" class="px-6 py-3">
                Service Provider 
              </th>
          </tr>
          ...
          <th  scope="col" style="text-align: center; border-left: 1px solid rgb(224, 224, 224);position: sticky; left: 0; background-color: #fdfdfd;" class="px-6 py-3">Emp Name</th>
            <th scope="col" style="text-align: center; border-left: 1.5px solid rgb(160, 160, 160); background-color: rgba(194, 238, 255, 0.2);" class="px-6 py-3">Basic Salary</th>
            ...
            <th scope="col" style="text-align: center; border-left: 1px solid rgb(224, 224, 224); background-color: rgba(255, 231, 194, 0.2);" class="px-6 py-3">holidays</th>
            ...
            <!-- <th scope="col" style="text-align: center; border-left: 1px solid rgb(224, 224, 224); background-color: rgba(255, 231, 194, 0.2);" class="px-6 py-3">PAYOUT as per  days</th> -->
            ...
            <th scope="col" style="text-align: center;  border-left: 1.5px solid rgb(160, 160, 160); top: 50px; background-color: #fdfdfd;" class="px-6 py-3">Salary Payout</th>
            <th scope="col" style="text-align: center;  border-left: 1.5px solid rgb(160, 160, 160); position: sticky; right: 198px; top: 50px; background-color: #fafdfa;" class="px-6 py-3">Service Fee %</th>
            <th scope="col" style="text-align: center;  border-left: 1.5px solid rgb(160, 160, 160); position: sticky; right: 0; top: 50px; background-color: #fafdfa;" class="px-6 py-3">Service Fee</th>
          </tr>
            </thead>
            <tbody>
            <?php
...
misc.damt,
COALESCE(sp.sfper, 0) AS sfper,
COALESCE(sp.sfee, 0) AS sfee,
COALESCE(sp.service_provider, '') AS service_provider,
COALESCE(sp.empname, '') AS sp_empname
...
LEFT JOIN emp ON ms.empname = emp.empname AND emp.empty = 'Service Provider'
LEFT JOIN payroll_sp sp ON ms.empname = sp.empname
WHERE payroll_schedule.approval = 0
AND emp.empstatus = 0
AND (emp.empname IS NOT NULL OR sp.empname IS NOT NULL)
UNION
SELECT
ms.empname,
ms.emp_no,
...
ORDER BY emp_no ASC";
 ...
 ") or die(mysqli_error($con));
           ...
           <?php echo $smonth ?>
                    ...
                    <!-- <td class="px-6 py-4" style="text-align: center; border-left: 1px solid rgb(224, 224, 224); background-color: rgba(255, 231, 194, 0.2);">
                  <input type="number" value="<?php echo $perday; ?>" style="width:110px;background-color: rgba(194, 238, 255, 0.01);">
                  </td> -->
                    ...
                    <td class="px-6 py-4" style="text-align: center; border-left: 1.5px solid rgb(160, 160, 160); background-color: rgba(194, 255, 204, 0.2);">
                      <input type="number" name="bp" id="bp" value="" style="background-color: rgba(194, 238, 255, 0.01);" class="highlight">
                    </td>
                    <td class="px-6 py-4" style="text-align: center;  border-left: 1.5px solid rgb(224, 224, 224); background-color: rgba(194, 255, 204, 0.2);">
                      <input type="number" name="hra" id="hra" value="" style="background-color: rgba(194, 238, 255, 0.01);" class="highlight">
                    </td>
                    <td class="px-6 py-4" style="text-align: center;  border-left: 1.5px solid rgb(224, 224, 224); background-color: rgba(194, 255, 204, 0.2);">
                      <input type="number" name="oa" value="" style="background-color: rgba(194, 238, 255, 0.01);" class="highlight">
                    </td>
                    <td class="px-6 py-4" style="text-align: center;  border-left: 1.5px solid rgb(224, 224, 224); background-color: rgba(194, 255, 204, 0.2);">
                    ...
                    <td class="px-6 py-4" style="text-align: center;  border-left: 1.5px solid rgb(160, 160, 160); position: sticky; right: 198px; background-color: #fdfdfd;">
                    <input type="number" name="sfper" value="<?php echo $row['sfper']; ?>" style="background-color: rgba(194, 238, 255, 0.01);" class="highlight">
                  </td>
                    <td class="px-6 py-4" style="text-align: center;  border-left: 1.5px solid rgb(160, 160, 160); position: sticky; right: 0; background-color: #fdfdfd;">
                    <input type="number" name="sfee" value="<?php echo $row['sfee']; ?>" style="background-color: rgba(194, 238, 255, 0.01);" class="highlight">
                  </td>
...
<script>
        document.querySelectorAll('.clickable-row').forEach(function(row) {
            row.addEventListener('click', function() {
                document.querySelectorAll('.clickable-row').forEach(function(r) {
...
function updateSalariesAndAllowances() {
    $('tbody tr').each(function() {
        ...
        var epf1FromDB = parseFloat($(this).find('input[name="epf1"]').val()) || 0;
        var esi1FromDB = parseFloat($(this).find('input[name="esi1"]').val()) || 0;
        ...
        var lopamt = parseFloat($(this).find('input[name="lopamt"]').val()) || ((gs / monthdays) * flop);
...
<script>
  function submitFormData() {
    ...
    $("#ssTableBody tbody tr").each(function(index, element) {
      var empName = $(element).find('td:eq(1)').text().trim() || '';
      var salarymonth = $(element).find('td:eq(2)').text().trim() || '';
      ...
      var holidays = $(element).find('input[name="holidays"]').val().trim() || '';
      ...
      var sfper = $(element).find('input[name="sfper"]').val().trim() || '';
      var sfee = $(element).find('input[name="sfee"]').val().trim() || '';
