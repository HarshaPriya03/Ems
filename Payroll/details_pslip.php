    ...
    <div style="background-color: #f9f9f9; height:100svh;">
        ...
        <div>
            ...
            <p style="position: absolute; right: 70px; font-size: 14px; top: 200px; color: #666666;">
                Present Days<span style="position:relative;left:0px;"> : <?php echo $present; ?></span> | Leaves : <?php echo $leaves; ?> <br>Week Off's <span style="position:absolute;left:77px;">: <?php echo $sundays; ?> </span> <br> Paid Days <span style="position:absolute;left:77px;">: <?php echo $paydays; ?> </span><?php if ($flop != 0) : ?><span style="position:absolute;left:113px;width:120%;"> | Loss of Pay : <?php echo $flop; ?></span><?php endif; ?></p>
