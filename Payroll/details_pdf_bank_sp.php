...
<head>
  ...
  <title>ICICI-NEFT-<?php echo $smonth ?> </title>
  <style>
table, th, td {
...
<table border="1" cellspacing="0" align="center" >
      ...
      <?php
       $salaryMonth = $smonth; 
       $sql1 = "SELECT 
       SUM(payout + sfee) AS total_payout
   FROM 
       payroll_ss_sp
   WHERE 
 ...
 $sql = "
   SELECT 
    ...
    FROM 
        payroll_ss_sp
    LEFT JOIN emp ON payroll_ss_sp.empname = emp.empname
    LEFT JOIN payroll_ban ON payroll_ss_sp.empname = payroll_ban.empname
    WHERE 
        payroll_ss_sp.salarymonth = '$salaryMonth' 
        AND payroll_ss_sp.sfee = 0 
    GROUP BY 
        payroll_ss_sp.empname, 
 ...
 ";
      ...
      <tbody>
        <tr>
          ...
          <?php echo str_replace(',', '', number_format($total_payout, 0)); ?>
          </td>
          <td >
            11
          </td>
          ...
          <td style="text-transform: uppercase;">
            SALARY FOR THE MONTH OF <?php echo $salaryMonth ?>
          </td>
        </tr>
      </tbody>
      <?php
