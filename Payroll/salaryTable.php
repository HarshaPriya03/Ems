...
$sql4 = "SELECT COUNT(*) AS count FROM payroll_msalarystruc ";
                ...
                <div id="accordion-color-body-1" class="hidden bg-gray-50" aria-labelledby="accordion-color-heading-1">
                    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                        <p class="mb-2 text-gray-500 dark:text-gray-400">
                            ...
                            This table provides a comprehensive overview of the components comprising an employee's fixed salary. It encompasses base pay, allowances, and deductions, providing transparency and clarity regarding the fundamental components of an individual's compensation package
                        </p>
                    </div>
                </div>
            </div>
            <a href="./updatesalary.php"><button style="position:absolute; right:0px; top:10px;" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Update Employee Salary</button></a>
            <div style="overflow-x:hidden;height:72%;">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead style="position:sticky;top:0;" class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr style="border-top: 1px solid rgb(224, 224, 224);">
                            <th colspan="3" style="text-align: center;" scope="col" class="px-6 py-3">
                                Employee Details
                            </th>
                        ...
                        <tr style="border-top: 1px solid rgb(224, 224, 224);">
                            <th colspan="2"></th>
                            <th scope="col" style="text-align: center; border-left: 1px solid rgb(224, 224, 224);" class="px-6 py-3">Employee Name</th>
                            ...
                            <th scope="col" style="text-align: center;  border-left: 1.5px solid rgb(160, 160, 160); background-color: rgba(194, 255, 204, 0.2);" class="px-6 py-3">Pension, ESIC, ...</th>
                            <th scope="col" style="text-align: center;  border-left: 1.5px solid rgb(160, 160, 160); background-color: rgba(255, 194, 194, 0.2);" class="px-6 py-3">EPF, ESIC, ...</th>
                            <th scope="col" style="text-align: center;  border-left: 1.5px solid rgb(160, 160, 160); background-color: rgba(203, 197, 252, 0.2);" class="px-6 py-3">GROSS Pay</th>
             ...
             ";
                    ...
                    while ($result = mysqli_fetch_assoc($que)) {
                        ...
                        $total_empcontributions = $result['epf1'] + $result['esi1']  + $result['tds'];
                    ?>
                        <tbody>
           ...
           (SELECT SUM(ctc) FROM payroll_msalarystruc) AS total_ctc, 
           (SELECT SUM(bp) FROM payroll_msalarystruc) AS total_abp";
                        ...
                        <tfoot style="position:sticky;bottom:0;" class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <td class="px-6 py-4" colspan=2></td>
                            <td class="px-6 py-4 whitespace-nowrap" style="text-align: center; font-size: 15px; border-left: 1px solid rgb(224, 224, 224); font-weight: 500;"></td>
                            <td class="px-6 py-4 whitespace-nowrap" style="text-align: center; font-size: 15px; border-left: 1.5px solid rgb(160, 160, 160); font-weight: 500;">₹ <?php echo $total_abp ?>/-</td>
                            <td class="px-6 py-4 whitespace-nowrap" style="text-align: center; font-size: 15px; border-left: 1px solid rgb(224, 224, 224); font-weight: 500;">₹ <?php echo $total_hra ?>/-</td>
                            <td class="px-6 py-4 whitespace-nowrap" style="text-align: center; font-size: 15px; border-left: 1px solid rgb(224, 224, 224); font-weight: 500;">₹ <?php echo $total_oa ?>/-</td>
                            <td class="px-6 py-4 whitespace-nowrap" style="text-align: center; font-size: 15px; border-left: 1.5px solid rgb(160, 160, 160); font-weight: 500;">₹ <?php echo $total_eycontributions ?>/-</td>
                            <td class="px-6 py-4 whitespace-nowrap" style="text-align: center; font-size: 15px; border-left: 1.5px solid rgb(160, 160, 160); font-weight: 500;">₹ <?php echo $total_empcontributions ?>/-</td>
                            <td class="px-6 py-4 whitespace-nowrap" style="text-align: center; font-size: 15px; border-left: 1.5px solid rgb(160, 160, 160); font-weight: 500;">₹ <?php echo $total_ctc ?>/-</td>
                            <td class="px-6 py-4 whitespace-nowrap" style="text-align: center; font-size: 15px; border-left: 1.5px solid rgb(160, 160, 160); font-weight: 500;">₹ <?php echo $total_netpay ?>/-</td>
                        </tfoot>
                </table>
            </div>
    ...
    <div class="logout14" style="font-size:25px; font-weight:normal; margin-top:-8px;">Logout</div>
    <a href="./payroll.php" class="payroll14" style="color: white; z-index:9999; font-size:25px; font-weight:350; margin-top:-5px;">Payroll</a>
    <a class="reports14" style="font-size:25px; font-weight:350; margin-top:-5px;">Reports</a>
    ...
    <a class="dashboard14" style="font-size:25px; font-weight:350; margin-top:-5px;" href="../index.php" id="dashboard">Dashboard</a>
    <a class="fluentpeople-32-regular14" id="fluentpeople32Regular">
        <img class="vector-icon73" alt="" src="./public/vector7.svg" />
    </a>
    <a class="employee-list14" style="font-size:25px; font-weight:350; margin-top:-5px;" href="../employee-management.php" id="employeeList">Employee List</a>
    ...
    <a class="leaves14" id="leaves" style="font-size:25px; font-weight:350; margin-top:-5px;" href="../leave-management.php">Leaves</a>
    <a class="fluentperson-clock-20-regular14" id="fluentpersonClock20Regular">
        <img class="vector-icon75" alt="" src="./public/vector1.svg" />
    </a>
    <a class="onboarding16" style="font-size:25px; font-weight:350; margin-top:-5px;" id="onboarding" href="../onboarding.php">Onboarding</a>
    <a class="fluent-mdl2leave-user14" id="fluentMdl2leaveUser">
        <img class="vector-icon76" alt="" src="./public/vector.svg" />
    </a>
    <a class="attendance14" style="font-size:25px; font-weight:350; margin-top:-5px; color: black;" href="../attendence.php">Attendance</a>
