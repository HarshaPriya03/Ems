...
<head>
    ...
    <style>
       ...
       .data td:nth-child(39),
       .data td:nth-child(40){
...
<body>
    <div style="display: flex; justify-content: space-between;margin-bottom: 0;">
        ...
        <h1 style="text-align: center;">
            <u>SERVICE PROVIDER EMP's SALARY STATEMENT FOR THE MONTH of <?php echo $smonth; ?></u>
        </h1>
    ...
    <table border="1" style="border-color: rgb(170, 170, 170);width:100%;margin-top:-120px;" cellspacing="0">
        ...
        <tr class="data1">
            ...
            <th style="background:#ffd961;">Bonus</th>
            ...
            <th style="background:#92d050;">Service Fee (%)</th>
            <th style="background:#92d050;">Service Fee</th>
        </tr>
        <tbody>
            <?php
          ...
          emp.empname, 
          payroll_ban.*,
          (payroll_ss_sp.emi + payroll_ss_sp.misc) AS MISC
      FROM 
          payroll_ss_sp
      LEFT JOIN 
          emp ON payroll_ss_sp.empname = emp.empname
      LEFT JOIN 
          payroll_ban ON payroll_ss_sp.empname = payroll_ban.empname
      WHERE 
          payroll_ss_sp.salarymonth = '$currentMonth'
      ORDER BY 
          payroll_ss_sp.emp_no ASC";
            ...
            ?>
                       <tr class="data">
                        ...
                        <td>ANIKA STERILIS PRIVATE LIMITED</td>
                        <td><?php echo $result['sfper']; ?></td>
                        <td style="background:#FFCF96;padding:21px;"><?php echo $result['sfee']; ?></td>
                    </tr>
...
<?php 
    $sql = "SELECT 
    SUM(payroll_ss_sp.payout) AS total_payout,
    SUM(payroll_ss_sp.sfee) AS total_sfee
FROM 
    payroll_ss_sp
WHERE 
    payroll_ss_sp.salarymonth = '$currentMonth'";
