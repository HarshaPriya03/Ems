...
<body>
    <div class="attendence4">
        ...
        <div class="rectangle-parent23" style="margin-top:-60px;">
            <button style="position: absolute; top: -10px; left: 1250px;" data-modal-target="default-modal" data-modal-toggle="default-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                + Add New Bonus
            </button>
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <form id="employeeForm">
                                ...
                                <div class="p-4 md:p-5 space-y-4" style="margin-left: 65px;">
                                    <!--<p style="font-size: 13px; font-weight: 500; position: absolute; right: 30px;">BONUS ID: ASPLBONUS202401230001</p> <br>-->
                                    <label>Bonus Type:</label>
                                    <input type="text" name="bonus" style="width: 300px; border-radius: 5px; margin-left: 6px;">
                                    <div style="display: flex;">
                                        <label>Bonus Amount:</label>
                                        <div style="display: flex; border: 1px solid rgb(185,185,185); width: 30px; align-items: center; justify-content: center; background-color: rgb(240, 240, 240); border-top-left-radius: 10px; border-bottom-left-radius: 10px; margin-left: 22px;">₹</div>
                                        <input type="text" name="amt" style="font-size: 18px; width: 198px; height: 40px; border: 1px solid rgb(185,185,185);">
                                    ...
                                    <div style="margin-top: 20px;">
                                        ...
                                        <textarea name="notes" cols="45" rows="3" style="border-radius: 5px;"></textarea>
                                    </div>
                                </div>
                                <!-- Modal footer -->
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <?php
                $cnt = 1;
                $sql = "SELECT * FROM payroll_bonus  ORDER BY ID ASC";
        ...
        <button style="position: absolute; top: 400px; left: 1250px;" data-modal-target="default-modals" data-modal-toggle="default-modals" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
            + Allocate Bonus
        </button>
        <div style="margin-top: 60px; height: 350px; overflow-y: auto;">
            <!-- Main modal -->
                                    ...
                                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" style="width: 500px;">
                                        ...
                                        <tbody style="text-align: center;">
                                            ...
                                            if ($work_location == 'Visakhapatnam') {
                                                $sql = "SELECT * FROM emp WHERE work_location = 'Visakhapatnam' ORDER BY emp_no ASC ";
                                            } elseif ($work_location == 'Gurugram') {
                                                $sql = "SELECT * FROM emp WHERE work_location = 'Gurugram' ORDER BY emp_no ASC ";
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                if ($work_location == 'Visakhapatnam') {
                    $sql = "
    SELECT pb.*, e.work_location
    FROM payroll_bonusamt pb
    JOIN emp e ON pb.empname = e.empname
...
";
                ...
                ?>
                    ...
                    ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td colspan="8" class="px-6 py-4 text-center">No history</td>
                    </tr>
                <?php
                }
                ?>
