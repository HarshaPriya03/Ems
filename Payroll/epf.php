...
<body>
  <div class="attendence4">
    ...
    <div class="rectangle-parent22" style="margin-left: 60px;">
      ...
      <a class="frame-child188" href="salarystatement.php" style="background-color: #e8e8e8;"> </a>
      <a class="frame-child189" id="rectangleLink1" style="background-color: #ffe2c6;" href="epf.html"> </a>
      <a class="frame-child190" id="rectangleLink2" href="esi.php"> </a>
      <a class="attendence5" style="margin-left: 7px; width: 140px; margin-top: -4px; color: black;" href="salarystatement.php">Statement</a>
      <a class="records5" id="records" style="margin-left: 20px; width: 110px; margin-top: -4px; color: #ff5400;" href="epf.html">EPF</a>
    ...
    <div class="rectangle-parent23">
      ...
      <form id="payrollForm" style="height:730px;overflow-x:auto;">
          ...
          ?>
              <tbody style="text-align: center;">
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td class="px-6 py-4"><?php echo $result['pension']; ?></td>
                </tr>
              </tbody>
            <?php
              $cnt++;
      ...
      <div id="drawer-contact" style="z-index: 99999999999999;" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-contact-label">
              ...
              <div class="p-4 md:p-5 space-y-4">
                ...
                <div class="relative overflow-x-auto">
                  <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <?php
                    $sql = "SELECT * FROM payroll_epf ORDER BY created ASC";
                    $que = mysqli_query($con, $sql);
                    $cnt = 1;
                    if (mysqli_num_rows($que) > 0) {
                      while ($result = mysqli_fetch_assoc($que)) {
                    ?>
                        <tbody>
                          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                              <a target="_blank" href="docs/<?php echo $result['epfdoc']; ?>"> <svg fill="#ff7b24" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" viewBox="0 0 442.04 442.04" xml:space="preserve" stroke="#ff7b24" stroke-width="10.60896">
                                  <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                  <g id="SVGRepo_iconCarrier">
                                    <g>
                            ...
                            <td class="px-6 py-4">
                              <a download href="docs/<?php echo $result['epfdoc']; ?>">
        ...
        <form id="epfDoc">
          ...
          <div class="mb-6">
            ...
            <input name="epfdoc" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file" required>
          </div>
    ...
    $('#submitBtn').click(function(e) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $('#epfDoc').submit(); // Submit the form if confirmed
        }
      });
    });

    $('#epfDoc').submit(function(e) {
      e.preventDefault();
