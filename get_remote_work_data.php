...
while ($row = mysqli_fetch_assoc($result)) {
   ...
   <div class="mb-6 pb-6 border border-gray-400 shadow-sm rounded-lg p-6 bg-gray-50 dark:bg-gray-800"">
    ...
    if ($row['status'] == 0) {
        $output .= '
        <div class="inline-flex items-center px-4 py-2 bg-yellow-100 border border-yellow-400 rounded-lg">
        ...
        <div class="inline-flex items-center px-4 py-2 bg-green-100 border border-green-400 rounded-lg">
            ...
            <span class="text-sm font-medium text-green-700">Work Verified by Manager</span>
        </div>';
    }
