...
<body>
  <div class="punchin">
    ...
    <div class="rectangle-parent18">
      ...
      <a class="attendence2" style="margin-left: -155px; margin-top:-4px;" id="attendence">Attendance</a>
      <a class="records2" id="records" style="color:orangered;cursor: none; margin-left:-158px; margin-top:-4px;">Check IN</a>
      <a href="punchout.php" class="punch-inout2" style="color:#000000;margin-left:-135px; margin-top:-4px;">Check OUT</a>
      <a class="my-attendence2" id="myAttendence" style="margin-left: -160px; width:200px; margin-top:-4px;">Break In/Out Log</a>
      <a href="attendancelog.php" class="frame-child163" id="rectangleLink3" style="margin-left:80px;"> </a>
      <a href="attendancelog.php" class="my-attendence2" id="myAttendence" style="margin-left:75px; margin-top:-4px;">Attendance Log</a>
    </div>
    ...
    <div class="rectangle-parent19">
      ...
      <div class="employee-name6" style="margin-top: -45px; margin-left:600px">Device Service Tag</div>
      ...
      <form id="updateForm">
        ...
        <!-- <input class="frame-child167" style="font-size: 20px; margin-top: 45px; height: 40px;" type="text" /> -->
  ...
  $sql = "SELECT empname, UserId, work_location FROM emp WHERE empstatus=0 AND work_location = '$work_location'";
        ...
        <input class="frame-child166" style="font-size: 20px; margin-top: -50px; height: 40px; margin-left:600px;" name="ServiceTagId" id="ServiceTagId">
