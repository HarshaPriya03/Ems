...
ORDER BY date ASC";
          ...
          ?>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td class="px-6 py-4"><?php echo $result['value']; ?></td>
              <td class="px-6 py-4"><?php echo $date; ?></td>
              <td class="px-6 py-4"><?php echo $month; ?></td>
              <td class="px-6 py-4"><?php echo $day; ?></td>
              <td class="px-6 py-4">
                <?php
    ...
    <a class="attendence-management4" href="./reports.html" style="text-align: center; width: 60%;" id="attendenceManagement">Holiday Report</a>
  </div>
</body>
