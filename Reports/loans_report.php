  ...
  <div class="attendence4">
    ...
    <div class="rectangle-parent23">
      <div style="display: flex; position: absolute; top: -20px; right: 60px;">
        <a href="print_loan_report.php" target="_blank" class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
        ...
        ORDER BY pl.loanno ASC";
          ...
          ?>
               <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td class="px-6 py-4"><?php echo $result['stmonth']; ?></td>
                  <td class="px-6 py-4"><?php echo $result['loterm']; ?></td>
                  <td class="px-6 py-4"><?php echo $result['mop']; ?></td>
                  <td class="px-6 py-4"><?php echo $result['pdate']; ?></td>
                  <td class="px-6 py-4"><?php echo $result['tno']; ?></td>
                   <td class="px-6 py-4">
                   <?php
                    if ($result['status'] == 1) {
                      echo"OPEN";
                   ...
                   <td>
                   <a href="#" data-id="<?php echo $result['empname']; ?>" target="_blank"  class="download-link py-2.5 px-5 ms-3 text-sm font-medium text-blue-700 focus:outline-none bg-white rounded-lg border border-blue-200 hover:bg-gray-100 hover:text-gray-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                Download</a> 
                   </td>
               </tr>
               <?php
    ...
    <a class="attendence-management4" href="./reports.html" style="text-align: center; width: 60%;" id="attendenceManagement">Loans Report</a>
  </div>
