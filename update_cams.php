...
$addoption = isset($_POST['addoption']) ? $_POST['addoption'] : '';
$ServiceTagId= $_POST['ServiceTagId'];
$posted = date('Y-m-d H:i:s');

$sql = "INSERT INTO CamsBiometricAttendance (UserID, AttendanceTime, AttendanceType, InputType,option,addoption,posted,ServiceTagId) 
