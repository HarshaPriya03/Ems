...
") or die(mysqli_error($db));
                ...
                <a style="text-decoration: none; color: inherit;" href="attendancelog_mgr.php" target="_blank"> <P class=" btn" style="outline:1px solid #FB8A0B;color:#F46114;white-space:nowrap; font-size:14px;"><img style="margin-bottom:4px;" src="https://upload.wikimedia.org/wikipedia/commons/archive/3/3b/20180610093750%21OOjs_UI_icon_alert-warning.svg">: Check Attendance Log</P></a>
                </div> -->
